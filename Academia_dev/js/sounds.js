...
if (typeof window.updatePomDots !== 'function') {
  window.updatePomDots = function() {
...
if (typeof window.renderPomHistory !== 'function') {
  window.renderPomHistory = function() {
...
if (typeof window.renderPomGoal !== 'function') {
  window.renderPomGoal = function() {
...
if (typeof window._renderPomWeekStats !== 'function') {
  window._renderPomWeekStats = function() {
    const arr = _getPomWeekHistory();
...
if (typeof window.closeModal !== 'function') {
  window.closeModal = function(id) { _uiClick('modal-close'); document.getElementById(id)?.classList.remove('open'); };
}
