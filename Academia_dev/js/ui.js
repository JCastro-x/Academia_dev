...
if (typeof window.fillMatSels !== 'function') {
  window.fillMatSels = function() {
...
if (typeof window.fillTopicMatSel !== 'function') {
  window.fillTopicMatSel = function() {
...
if (typeof window.fillPomSel !== 'function') {
  window.fillPomSel = function() {
...
if (typeof window.fillNotesSel !== 'function') {
  window.fillNotesSel = function() {
...
if (typeof window.fillExamSel !== 'function') {
  window.fillExamSel = function() {
...
if (typeof window.renderOverview !== 'function') {
  window.renderOverview = function() { _schedRender(_renderOverview); };
}
